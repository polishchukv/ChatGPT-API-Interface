...
class customGPTGUI:
    ...
    def setupInput(self):
        ...
        self.input_field = ctk.CTkTextbox(self.input_frame, font=ctk.CTkFont(family="Roboto", size=15))
        self.input_field.pack(fill="x", expand=True, padx=10)

        self.input_button = ctk.CTkButton(self.input_frame, text="Generate Response", width=20, command=self.testCommand, font=ctk.CTkFont(family="Roboto", size=15))
    ...
    def setupOptions(self):
        ...
        self.save_button = ctk.CTkButton(self.options_frame, text="Customize", width=10, font=ctk.CTkFont(family="Roboto", size=15), command=self.open_customization_window)
        self.save_button.pack(side="left", padx=1)

        self.save_button = ctk.CTkButton(self.options_frame, text="Save Output", width=10, font=ctk.CTkFont(family="Roboto", size=15))
        self.save_button.pack(side="left", padx=1)

        self.load_button = ctk.CTkButton(self.options_frame, text="Load Output", width=10, font=ctk.CTkFont(family="Roboto", size=15))
        self.load_button.pack(side="left", padx=1)

        self.load_button = ctk.CTkButton(self.options_frame, text="Clear", width=10, font=ctk.CTkFont(family="Roboto", size=15))
        self.load_button.pack(side="left", padx=1)

        self.version_box = ctk.CTkComboBox(self.options_frame, values=["4.0", "3.5"], command=self.testCommand, width=60, state="readonly", font=ctk.CTkFont(family="Roboto", size=15))
    ...
    def setupOutput(self):
        ...
        self.output_field = ctk.CTkTextbox(self.output_frame, state="disabled", font=ctk.CTkFont(family="Roboto", size=15))
